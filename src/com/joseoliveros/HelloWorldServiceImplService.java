 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceImplService", targetNamespace = "http://joseoliveros.com/", wsdlLocation = "http://localhost:9090/hellosoap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICEIMPLSERVICE_QNAME = new QName("http://joseoliveros.com/", "HelloWorldServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/hellosoap?wsdl");
    ...
    public HelloWorldService getHelloWorldServiceImplPort() {
        return super.getPort(new QName("http://joseoliveros.com/", "HelloWorldServiceImplPort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://joseoliveros.com/", "HelloWorldServiceImplPort"), HelloWorldService.class, features);
    }
